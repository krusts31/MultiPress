...
multi-prod:
	sudo bash ./srcs/requirements/certbot/init-letsencrypt.sh olgrounds.dev lt.olgrounds.dev et.olgrounds.dev lv.olgrounds.dev de.olgrounds.dev files.olgrounds.dev
	docker compose -f srcs/docker-compose-multi-site-wordpress.yaml --env-file srcs/.env-prod up --build -d
	bash ./srcs/tools/wait.sh
	sudo bash ./srcs/requirements/certbot/post-letsencrypt.sh olgrounds.dev lt.olgrounds.dev et.olgrounds.dev lv.olgrounds.dev de.olgrounds.dev files.olgrounds.dev
